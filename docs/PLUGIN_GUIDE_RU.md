# Практический контракт плагина Soft Hub 0.6.9

Этот документ — инструкция для автора нового софта под Soft Hub 0.6.9 и контракт `SH-SOFTWARE-0.6/3`. Он описывает фактически реализованный контракт, а не желаемую будущую платформу. Источники истины в репозитории:
